...
Kickstart.nvim is a template for your own configuration.
  ...
  Onfe you've done that, you should start exploring, configuring and tinkering to
  explore Neovim!
...
vim.keymap.set('n', '<C-Left>', switch_to_split('left'))
vim.keymap.set('n', '<C-Down>', switch_to_split('down'))
vim.keymap.set('n', '<C-Up>', switch_to_split('up'))
vim.keymap.set('n', '<C-Right>', switch_to_split('right'))
